...
<head>
    ...
    <link rel="stylesheet" href="../CSS/dden.css">
...
<body>
  ...
  if(isset($_POST["submit"])){
    $dDen=$_POST["dDen"];
    $madDen=$_POST["madDen"];
    $sql="INSERT INTO loaitour(dDen,madDen) VALUES ('$dDen','$madDen')";
    if ($conn->query($sql) == TRUE){
      echo"";
      header("Location:dden.php");
  }
}
   ?>
<!-- menuBar -->
...
<h1>Thêm điểm đến mới</h1>
<form action="" method="post">
<p>Mã điểm đến: <input type="text" name="madDen"></p>
<p>Tên điểm đến: <input type="text" name="dDen"></p>
