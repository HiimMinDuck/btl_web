...
<div class="tour">
      ...
      <div class="kg">
        <form action="tourDuLich1.php" method="get">
          <ul>
            ...
            <li><input type="checkbox" class="ck" name="Gia[]" value="giaTour between 4001000 and 6000000"><label>4.001.000đ - 6.000.000đ</li>
            <li><input type="checkbox" class="ck" name="Gia[]" value="giaTour between 6001000 and 8000000"><label>6.001.000đ - 8.000.000đ</li>
            <li><input type="checkbox" class="ck" name="Gia[]" value="giaTour >= 8001000"><label>Giá trên 8.001.000đ</li>
          </ul>
  ...
  <div class="containe">
    ...
    <div class="title-right">
      <div class="">
        <div class="line">
          <h1 class="line-1">Tất cả Tour đã lọc theo giá</h1>
          <hr>
        </div>
        <?php
        if ($leng=='4') {
          header("Location:tourDuLich.php");
        }
        else {
          $i=1;
          foreach ($_GET['Gia'] as $Gial) {
            $sql="SELECT * FROM tour WHERE $Gial";
